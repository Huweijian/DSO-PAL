...
class LineSegmentDetectorImplMy : public LineSegmentDetector
{
public:
 ...
 */
    LineSegmentDetectorImplMy(int _refine = LSD_REFINE_STD, double _scale = 0.8,
...
private:
    ...
    LineSegmentDetectorImplMy& operator= (const LineSegmentDetectorImplMy&); // to quiet MSVC
...
{
    return makePtr<LineSegmentDetectorImplMy>(
...
LineSegmentDetectorImplMy::LineSegmentDetectorImplMy(int _refine, double _scale, double _sigma_scale, double _quant,
...
void LineSegmentDetectorImplMy::detect(InputArray _image, OutputArray _lines,
...
void LineSegmentDetectorImplMy::flsd(std::vector<Vec4f>& lines,
    std::vector<double>& widths, std::vector<double>& precisions,
    std::vector<double>& nfas)
{
    // Angle tolerance
...
void LineSegmentDetectorImplMy::ll_angle(const double& threshold,
                                   const unsigned int& n_bins)
{
	...
	// hwjdebug ---------------------------
	{
		...
		cvtColor(hsv, angle_bgr, COLOR_HSV2BGR);
...
void LineSegmentDetectorImplMy::region_grow(const Point2i& s, std::vector<RegionPoint>& reg,
                                      double& reg_angle, const double& prec)
{
    reg.clear();
...
void LineSegmentDetectorImplMy::region2rect(const std::vector<RegionPoint>& reg,
...
double LineSegmentDetectorImplMy::get_theta(const std::vector<RegionPoint>& reg, const double& x,
                                      const double& y, const double& reg_angle, const double& prec) const
{
    double Ixx = 0.0;
    double Iyy = 0.0;
...
bool LineSegmentDetectorImplMy::refine(std::vector<RegionPoint>& reg, double reg_angle,
                                 const double prec, double p, rect& rec, const double& density_th)
{
...
bool LineSegmentDetectorImplMy::reduce_region_radius(std::vector<RegionPoint>& reg, double reg_angle,
                const double prec, double p, rect& rec, double density, const double& density_th)
{
...
double LineSegmentDetectorImplMy::rect_improve(rect& rec) const
{
    double delta = 0.5;
...
double LineSegmentDetectorImplMy::rect_nfa(const rect& rec) const
{
...
double LineSegmentDetectorImplMy::nfa(const int& n, const int& k, const double& p) const
{
    // Trivial cases
...
inline bool LineSegmentDetectorImplMy::isAligned(int x, int y, const double& theta, const double& prec) const
{
...
void LineSegmentDetectorImplMy::drawSegments(InputOutputArray _image, InputArray lines)
{
...
int LineSegmentDetectorImplMy::compareSegments(const Size& size, InputArray lines1, InputArray lines2, InputOutputArray _image)
{
