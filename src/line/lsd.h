 ...
 */
    LineSegmentDetectorMy(int _refine = LSD_REFINE_STD, double _scale = 0.8,
...
private:
    ...
    LineSegmentDetectorMy& operator= (const LineSegmentDetectorMy&); // to quiet MSVC
