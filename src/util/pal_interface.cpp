...
bool init_pal(string calibFile){
	...
	cv::circle(pal_mask_g[0], cv::Point(pal_model_g->xc_, pal_model_g->yc_), pal_model_g->mask_radius[1]-4, 255, -1);
	cv::circle(pal_mask_g[0], cv::Point(pal_model_g->xc_, pal_model_g->yc_), pal_model_g->mask_radius[0]+4, 0, -1);
